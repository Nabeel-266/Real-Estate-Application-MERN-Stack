    ...
    <div className="w-full px-[2rem]">
      ...
      <div className="body w-full py-[2rem] flex flex-col gap-[2.5rem]">
        ...
        <div className="w-full">
          ...
          <div className="noPropertyViewCont hidden w-[80%] h-[38rem] relative z-[1] rounded-md p-[2rem] space-y-[0.5rem] before:content-[''] before:absolute before:z-[-1] before:top-0 before:left-0 before:w-full before:h-full before:bg-cover before:bg-no-repeat before:bg-center before:bg-no-property-found-image before:opacity-90">
            ...
            <p className="text-neutral-700 text-[1.8rem] leading-[2.4rem] font-semibold">
              {activeTab === "Draft"
          ...
          {/* Property Cards Cont */}
          <div className="propertyCardsCont w-full grid grid-cols-3 gap-[3rem_2rem] pb-[3rem] px-[2rem]">
            {/* Property Card */}
            {[1, 2, 3, 4, 5, 6].map((_, index) => (
              <div
                // key={index}
                className="propertyCard max-w-[35rem] min-w-[22rem] min-h-[25rem] relative bg-white overflow-hidden shadow-[0px_15px_20px_#e0e0e0] rounded-xl"
              >
                {/* Card Image */}
                ...
                <div className="cardContent w-full flex flex-col gap-[1rem] p-[1rem] text-neutral-700">
                  ...
                  {/* Controls */}
                  <div className="w-full flex items-center justify-between gap-[1rem] mt-[0.2rem]">
                    <button className="w-[50%] flex items-center justify-center gap-[0.5rem] text-[1.6rem] leading-[1rem] font-semibold text-theme-blue tracking-wider px-[1rem] py-[0.8rem] bg-transparent border-[0.2rem] border-theme-blue rounded-full hover:bg-theme-blue hover:text-white transition-all duration-200">
                      <BiEditAlt size="1.5rem" />
                      <span>Edit</span>
                    </button>
                    <button className="w-[50%] flex items-center justify-center gap-[0.5rem] text-[1.6rem] leading-[1rem] font-semibold text-red-700 tracking-wider px-[1rem] py-[0.8rem] bg-transparent border-[0.2rem] border-red-700 rounded-full hover:bg-red-700 hover:text-white transition-all duration-200">
